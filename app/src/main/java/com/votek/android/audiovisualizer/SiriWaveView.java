...
public class SiriWaveView extends View {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        mFrequency = a.getFloat(R.styleable.SiriWaveView_waveFrequency, mFrequency);
    ...
    public void updatePath(Float frequency) {
        mPath.reset();
        phase += phaseShift;
    ...
    public void updateWaveFrequency(float frequency){
        mFrequency = frequency;
        updatePath(frequency);
    }
